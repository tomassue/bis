...
<?php include 'templates/loading_screen.php' ?>
    <div class="wrapper">
        ...
        <div class="main-panel">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <h2 class="mt-3" style="font-family: Book Antiqua; text-indent: 90px; line-height: 50px; text-align: justify;">
                                                ...
                                                ?>
                                                , <?= ucwords($brgy) ?>, <?= ucwords($resident['city']) ?> City</span>, is the same person listed in your master list named <span class="fw-bold text-uppercase"><?= $_SESSION['lname']; ?>, <?= $_SESSION['fname']; ?> <?= $_SESSION['mname']; ?>.,</span> <?= $_SESSION['purpose'] ?>.
                                            </h2>
            ...
            <!-- Name Modal -->
            <div class="modal fade" id="name" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"  data-backdrop="static" data-keyboard="false">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Enter the details below</h5>
                        </div>
                        <div class="modal-body">
                            <!-- <form method="POST" action="model/save_pment.php" > -->
                            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                <div class="form-group">
                                    <label>(Former) First Name<span class="text-danger"><b> *</b></span></label>
                                    <input type="text" name="fname" id="fname" class="form-control" placeholder="First Name" oninput="this.value = this.value.replace(/[^A-z\s]/g, '').replace(/(\..*)\./g, '$1');"  required>
                                </div>
                                <div class="form-group">
                                    <label>(Former) Middle Name<span class="text-danger"><b> *</b></span></label>
                                    <input type="text" name="mname" id="mname" class="form-control" placeholder="Middle Name" oninput="this.value = this.value.replace(/[^A-z\s]/g, '').replace(/(\..*)\./g, '$1');"  required>
                                </div>
                                <div class="form-group">
                                    <label>(Former) Last Name<span class="text-danger"><b> *</b></span></label>
                                    <input type="text" name="lname" id="lname" class="form-control" placeholder="Last Name" oninput="this.value = this.value.replace(/[^A-z\s]/g, '').replace(/(\..*)\./g, '$1');"  required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <small id="purposeHelp" class="form-text text-muted"><b>Ex: </b>who is a beneficiary of the Assistance for Individuals in Crisis Situation (AICS) of Sen. John Quill</small>
                                </div>
                        </div>
    ...
    <script>
        ...
        <?php endif ?>
            ...
            function printDiv(divName) {
                ...
                window.location.replace("resident_cert_of_oneness.php");
            }
    </script>
</body>
</html>