                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-button-action">
                                                                <a type="button" href="#edit" data-toggle="modal" class="btn btn-link btn-primary" title="Edit Purok" 
                                                                onclick="editPurok(this)" 
                                                                data-name="<?= $row['purok_name'] ?>" 
                                                                data-details="<?= $row['purok_details'] ?>" 
                                                                data-id="<?= $row['id_purok'] ?>">
