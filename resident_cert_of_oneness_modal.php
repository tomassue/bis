            ...
            <div class="modal-body">
                <form method="POST" action="generate_cert_of_oneness.php">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" onkeypress="return onlyAlphabets(event);" name="details" required>Certificate of Oneness for <?= ucwords($row['firstname'] . ' ' . $row['middlename'] . ' ' . $row['lastname'] . ($row['ext'] === '' ? '' : ', ' . $row['ext'])) ?></textarea>
                    </div>
                    <hr>
                    <div class="form-group">
