...
<?php if ($_SESSION['role'] == 'administrator') : ?>
    ...
    // $query_check_data_position = "SELECT * FROM tblposition";
    // $result_check_data_position = $conn->query($query_check_data_position);
    // $check_data_position = array();
    // while ($row = $result_check_data_position->fetch_assoc()) {
    //     $check_data_position[] = $row['position'];
    // }

    // $check_position = array("Barangay Chairman", "Barangay Kagawad", "SK Chairman", "Barangay Treasurer", "Barangay Secretary");
    ?>
    <!DOCTYPE html>
    <html lang="en">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="form-button-action">
                                                                        <a type="button" href="#edit" data-toggle="modal" class="btn btn-link btn-primary" title="Edit Position" onclick="editPos(this)" data-pos="<?= $row['position'] ?>" data-order="<?= $row['order'] ?>" data-id="<?= $row['id_position'] ?>">
                                ...
                                <form method="POST" action="model/save_position.php">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="position">
                                            ...
                                            <?php
                                            // foreach ($check_position as $cp) {
                                            //     if (!in_array($cp, $check_data_position)) {
                                            //         echo "<option value=\"$cp\">$cp</option>";
                                            //     }
                                            // }
                                            ?>
                                        </select>
                                        <small class="form-text text-muted">Note: Must include BARANGAY before on any position if necessary.</small>
                                    </div>
                                    <div class="form-group">
                                        <label>Order</label>
