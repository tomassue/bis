<?php 
	...
	if(!empty($id)){
		...
		$query 		= "UPDATE tblofficials SET `honorifics`='$honorifics', `name`='$name', `id_chairmanship`='$chair', `id_position`='$pos', termstart='$start', termend='$end', `status`='$status' WHERE id_officials=$id";	
