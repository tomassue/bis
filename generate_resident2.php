...
<?php 
    ...
    // $query = "SELECT *,tblresident.id as id, tblpurok.id as purok_id, tbl_org.id as org_id FROM tblresident JOIN tblpurok ON tblpurok.id=tblresident.purok JOIN tbl_org ON tbl_org.id=tblresident.organization WHERE tblresident.id='$id'";
    // $result = $conn->query($query);
    // $resident = $result->fetch_assoc();
?>
<!DOCTYPE html>
								...
								<div class="card-body m-5" id="printThis">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                <input type="text" class="form-control fw-bold" style="font-size:20px" value="<?php if(empty($resident['identified_as'])){echo "N/A";}else{echo $resident['identified_as'];} ?>">
                                            </div>
                                        </div>
                                    </div>
