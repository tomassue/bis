...
$query2 = "SELECT * FROM tbl_household JOIN tblpurok ON tblpurok.id_purok=tbl_household.id_purok ORDER BY household_number ASC";
							...
							<div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">Add Resident [NEW] <i>(Page 2)</i></div>
									</div>
								</div>
								<div class="card-body">
												...
												<div class="row">
													<div class="col-md-4">
														<!-- <div class="form-group">
															...
															<input type="text" class="form-control householdnumber" id="householdnumber" name="householdnumber" placeholder="Enter Household Number" onkeyup="GetDetail(this.value)" required>
														</div> -->
														<div class="form-group">
															<label>Household Number</span><span class="text-danger"><b> *</b></span></label>
															<select class="form-control js-states input-lg " style="width:100%;" id="single" name="householdnumber" required>
																<?php foreach ($household as $row2) : ?>
																	<option value=""></option>
																	<option value="<?= $row2['id_household'] ?>">No. <?= $row2['household_number'] ?></option>
																<?php endforeach ?>
															</select>
														</div>
													</div>
