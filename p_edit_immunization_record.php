    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="model/edit_immunization_record.php" enctype="multipart/form-data" onsubmit="return confirm('Are you sure you want to proceed?');">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Tetanus-containing Vaccine</label>
                                <select class="form-control js-states immunizationSelect" style="width:100%" id="<?= $selectId ?>" name="tcv" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="date_given" value="<?= $row['date_given'] ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
            ...
            <div>
                <div class=" modal-footer">
                    ...
                    <input type="hidden" value="<?= $row['id_immunization_record'] ?>" name="id_immunization_record">
