                                    ...
                                    <div class="card-header">
                                        <div class="card-head-row">
                                            ...
                                            <div class="card-tools">
                                                <button class="btn btn-info btn-sm" id="yes" onclick="printDiv('printThis')">
                                                    <i class="fa fa-print"></i>
                                                    Print Certificate
                                                </button>
                                                <a type="button" href="resident_indigency.php" class="btn btn-sm btn-warning" onclick="return confirm('Are you sure you want to go back? You will have to repeat the process again from the previous page.')" data-original-title="Go Back">
                                    ...
                                    <div class="card-body bg-brgylogo m-5" id="printThis">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="text-center">
                                                    <h1 class="mt-4 fw-bold mb-5" style="font-family: Book Antiqua; font-size: 30px;">CERTIFICATE OF INDIGENCE</h1>
                                                </div>
                                                ...
                                                <h2 class="mt-3" style="font-family: Book Antiqua; text-indent: 90px; line-height: 50px; text-align: justify;">
                                                    <span class="fw-bold">A Certificate of Indigence is issued </span> to <span class="fw-bold text-uppercase" style="font-size:25px"><?= ucwords($resident['firstname'] . ' ' . $resident['middlename'] . ' ' . $resident['lastname']) ?></span>, of legal age, <span class="text-lowercase"><?= ucwords($resident['civilstatus']) ?></span>, <?= ucwords($resident['citizenship']) ?> Citizen, a resident at
                                                    <span>
                                                        <?php
                                                        ...
                                                        ?>
                                                        , <?= ucwords($brgy) ?>, <?= ucwords($resident['city']) ?> City</span>, Philippines. This further certifies that the annual income of
                                                    <?php
                                                    ...
                                                    ?>
                                                    parents still falls below the poverty threshold; hence, they too are destitute/ indigent.
                                                </h2>

                                                <h2 class="mt-3" style="font-family: Book Antiqua; text-indent: 90px; line-height: 50px; text-align: justify;">
                                                    This certification is issued upon the request of the above-named person for <?= $purpose ?> purpose/s and whatever legal purpose it may serve best.
                                                </h2>
