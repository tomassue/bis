...
<!--                                                                 <?php if($row['position'] == 'Secretary' || $row['position'] == 'Treasurer'): ?>
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <h2 class="mt-3" style="font-family: Book Antiqua; text-indent: 90px; line-height: 50px; text-align: justify;">
                                                This certification is issued upon the request of the above-named person for <?= $_SESSION['purpose'] ?> purpose/s and whatever legal purpose it may serve best.
                                            </h2>
    ...
    <script>
        ...
        <?php endif ?>
            ...
            function printDiv(divName) {
                ...
                window.location.replace("resident_indigency.php");
            }
